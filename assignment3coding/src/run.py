...
if args.function == 'pretrain':
    ...
    vanilla_trainer = trainer.Trainer(model, pretrain_dataset, None, tconfig)
    vanilla_trainer.config.ckpt_path = args.writing_params_path
    ...
    name_dataset = dataset.NameDataset(pretrain_dataset, open('birth_places_train.tsv', encoding='utf-8').read())
    
    finetune_trainer = trainer.Trainer(model, name_dataset, None, tconfig)
    finetune_trainer.config.ckpt_path = args.writing_params_path
